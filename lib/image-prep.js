...
export async function prepareImageForStamping(bytes, kind, options = {}) {
  ...
  // Keep the decoded size separate from the size actually embedded: after
  // trimming they differ, and conflating the two makes a placement box that
  // silently contradicts the source image.
